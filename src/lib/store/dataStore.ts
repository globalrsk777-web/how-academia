    ...
    const institutions = [
      {
        ...
        description: "Uganda's premier university located in Kampala, established in 1922",
      ...
      },
      {
        ...
        description: "Private university in Mukono, offering quality Christian-based education",
        address: "P.O Box 4, Mukono, Uganda",
      ...
      },
      {
        ...
        description: "Public university in Kampala, specializing in technical and vocational education",
      ...
      },
      {
        ...
        description: "Private Catholic university in Nkozi, promoting excellence in education",
        address: "P.O Box 5498, Nkozi, Uganda",
        phone: "+256-772-420-330",
        email: "info@umu.ac.ug",
        createdAt: new Date().toISOString(),
        updatedAt: new Date().toISOString(),
      },
    ];
